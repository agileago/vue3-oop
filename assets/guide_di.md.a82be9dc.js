import{_ as n,o as a,c as p,O as l}from"./chunks/framework.bb99b966.js";const F=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/di.md","filePath":"guide/di.md"}'),o={name:"guide/di.md"};function e(c,s,t,r,E,y){return a(),p("div",null,s[0]||(s[0]=[l(`<h3 id="依赖注入" tabindex="-1">依赖注入 <a class="header-anchor" href="#依赖注入" aria-label="Permalink to &quot;依赖注入&quot;">​</a></h3><p>依赖注入是一种在后端非常常见的设计模式，具体的依赖注入学习请看</p><ul><li><a href="https://zhuanlan.zhihu.com/p/311184005" target="_blank" rel="noreferrer">https://zhuanlan.zhihu.com/p/311184005</a></li><li><a href="https://zhuanlan.zhihu.com/p/113299696" target="_blank" rel="noreferrer">https://zhuanlan.zhihu.com/p/113299696</a></li></ul><p>本库的依赖注入使用了 <code>Angular</code> 早期的基于动态的依赖注入 <code>injection-js</code> <a href="https://github.com/mgechev/injection-js" target="_blank" rel="noreferrer">https://github.com/mgechev/injection-js</a>, 结合vue3进行了集成和优化，使用请看下面例子</p><div class="language-tsx vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">tsx</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> { VueService, VueComponent } </span><span style="color:#F97583;">from</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">&#39;vue3-oop&#39;</span></span>
...
<span class="line"><span style="color:#24292E;">    );</span></span>
<span class="line"><span style="color:#24292E;">  }</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div>`,7)]))}const u=n(o,[["render",e]]);export{F as __pageData,u as default};
